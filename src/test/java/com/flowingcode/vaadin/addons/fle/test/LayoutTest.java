 ...
 * #L%
 */
package com.flowingcode.vaadin.addons.fle.test;
...
import com.flowingcode.vaadin.addons.fle.FilterablelayoutDemoView;
...
public class LayoutTest {
	...
	public void testDemoLayout() {
		Route route = FilterablelayoutDemoView.class.getAnnotation(Route.class);
